...
class instruments(App):
    ...
    def construct_ui(self):
        ...
        self.btn1 = StyledButton(container=instruments_container, text="Left", variable_name=f"configure_A",
                     left=360, top=10 + 5*40, normal_color="#007BFF", press_color="#0056B3")
        # Connect Button
        self.btn2 = StyledButton(container=instruments_container, text="Right", variable_name=f"connect_B",
                     left=480, top=10 + 5 * 40, normal_color="#007BFF", press_color="#0056B3")
        ...
        self.btn1.do_onclick(lambda *_: self.run_in_thread(self.onclick_x_left))
        self.btn2.do_onclick(lambda *_: self.run_in_thread(self.onclick_x_right))
