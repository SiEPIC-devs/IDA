...
class fine_align(App):
    ...
    def construct_ui(self):
        ...
        StyledLabel(
            container=fine_align_setting_container, text="X Step", variable_name="x_step_lb", left=0, top=42,
        ...
        StyledLabel(
            container=fine_align_setting_container, text="um", variable_name="x_step_um", left=150, top=42,
            width=20, height=25, font_size=100, flex=True, justify_content="left", color="#222"
        )
        ...
        StyledLabel(
            container=fine_align_setting_container, text="Y Step", variable_name="y_step_lb", left=0, top=106,
            width=70, height=25, font_size=100, flex=True, justify_content="right", color="#222"
        )
        ...
        StyledLabel(
            container=fine_align_setting_container, text="um", variable_name="y_step_um", left=150, top=106,
            width=20, height=25, font_size=100, flex=True, justify_content="left", color="#222"
        )
