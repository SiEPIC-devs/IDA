...
class stage_control(App):
    ...
    def construct_ui(self):
        ...
        self.wvl = StyledSpinBox(
            container=sensor_control_container, variable_name="wvl_input", left=185, top=40, min_value=1456,
            max_value=1583, value=1550.0, step=0.1, width=65, height=24, position="absolute"
        )
        ...
        sweep_container = StyledContainer(
            container=sensor_control_container, variable_name="sweep_container", left=340, top=20,
            height=100, width=292, border=True
        )

        self.sweep_btn = StyledButton(
            container=sweep_container, text="Sweep", variable_name="sweep_button", font_size=90,
            left=10, top=15, width=82, height=28, normal_color="#007BFF", press_color="#0056B3"
        )

        self.configure = StyledButton(
            container=sweep_container, text="Configure", variable_name="configure_button", font_size=90,
            left=105, top=15, width=82, height=28, normal_color="#007BFF", press_color="#0056B3"
        )

        self.data_window_btn = StyledButton(
            container=sweep_container, text="Window", variable_name="data_window_button", font_size=90,
        ...
        self.range_start = StyledSpinBox(
            container=sweep_container, variable_name="range_start", left=90, top=55, min_value=1456,
            max_value=1583, value=1500.0, step=0.1, width=65, height=24, position="absolute"
        )
        ...
        self.range_end = StyledSpinBox(
            container=sweep_container, variable_name="range_end", left=200, top=55, min_value=1456,
            max_value=1583, value=1580.0, step=0.1, width=65, height=24, position="absolute"
        )
