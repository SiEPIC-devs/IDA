...
print("zero stage")
os.chdir(dir_path+"/MMC 100")
stage_zero=subprocess.Popen([sys.executable,"zero_xyz.pyc"], 
                                    stdout=subprocess.PIPE, 
                                    stderr=subprocess.STDOUT)

(output,err)=stage_zero.communicate()
stage_zero_status=stage_zero.wait()

print("stage zero done")
print(output)
print(err)

print("zero fiber")
os.chdir(dir_path+"/MMC 100")
zero_fiber=subprocess.Popen([sys.executable,"zero_fiber_angle.pyc"], 
                                    stdout=subprocess.PIPE, 
                                    stderr=subprocess.STDOUT)

(output,err)=zero_fiber.communicate()
fiber_zero_status=zero_fiber.wait()

print("zero fiber done")
print(output)
print(err)
...
camera_init=subprocess.Popen([sys.executable,"camera_init.pyc"], 
                                    stdout=subprocess.PIPE, 
                                    stderr=subprocess.STDOUT)
